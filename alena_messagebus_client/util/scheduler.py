"""
Функции планировщика сообщений.

Запланированное сообщение будет сохранено и не отправлено до тех
пор, пока не будут выполнены критерии временного периода.
"""
import json
import time
import logging
...
class EventScheduler(Thread):
    """Создает поток планировщика событий. Отправляет сообщения в установленное время зарегистрированным целям.

    Arguments:
        messagebus:  Шина.
        schedule_file:  Путь к файлу для сохранения событий при выходе.
    """
