...
Позволяет зарегистрировать обработчики конкретных типов сообщений,
поступающих из платформы виртуального ассистента,
а также отправлять сообщения другим клиентам (сервисам),
подключенным к платформе.
"""
